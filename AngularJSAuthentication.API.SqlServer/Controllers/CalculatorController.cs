...
namespace AngularJSAuthentication.API.Controllers
{
    ...
    public class CalculatorController : ApiController
    {
        ...
        {
            this.calcRepository = new CalculatorRepository();
            this.username = base.User.Identity.Name;
        }
       ...
       {
            calcRepository.DeleteCalculation(id);
            return Ok();
        }
        ...
        {           
            return Ok(calcRepository.GetCalculations(username));
        }
