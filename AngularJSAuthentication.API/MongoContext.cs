namespace AngularJSAuthentication.API
{
    ...
    public class MongoContext : IMongoContext
    {
        ...
        private readonly MongoCollection<Calculator> calculationCollection;
        ...
        public MongoContext()
        {
            ...
            calculationCollection = Database.GetCollection<Calculator>("calculator");
        }
        ...
        public MongoCollection<Calculator> Calculations
        {
            get { return calculationCollection; }
        }
    }
}
